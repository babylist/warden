...
/* harmony export */   dt: () => (/* binding */ uniqueResponseModels),
...
/** Distinct response models observed across hunks, only when they disagree (>1 distinct value). */
function uniqueResponseModels(models) {
    const unique = uniqueSorted(models);
    return unique && unique.length > 1 ? unique : undefined;
}
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Z: () => (/* binding */ writeFileAtomic)
/* harmony export */ });
...
function writeFileAtomic(path, content) {
    (0,node_fs__WEBPACK_IMPORTED_MODULE_0__.mkdirSync)((0,node_path__WEBPACK_IMPORTED_MODULE_1__.dirname)(path), { recursive: true });
    const tempPath = `${path}.${process.pid}.${Date.now()}.tmp`;
    try {
        (0,node_fs__WEBPACK_IMPORTED_MODULE_0__.writeFileSync)(tempPath, content);
        (0,node_fs__WEBPACK_IMPORTED_MODULE_0__.renameSync)(tempPath, path);
    }
    catch (error) {
        try {
            (0,node_fs__WEBPACK_IMPORTED_MODULE_0__.unlinkSync)(tempPath);
        }
...
// UNUSED EXPORTS: ExecError, GIT_NON_INTERACTIVE_ENV, execFileNonInteractive, execGitNonInteractive, execNonInteractive, getAnthropicApiKey, getMajorVersion, isPathLike, processInBatches, writeFileAtomic
...
// EXTERNAL MODULE: ./src/utils/fs.ts
var fs = __webpack_require__(95994);
