...
/* harmony export */   $R: () => (/* reexport safe */ _output_github_checks_js__WEBPACK_IMPORTED_MODULE_0__.$R),
...
/* harmony export */   RR: () => (/* reexport safe */ _output_github_checks_js__WEBPACK_IMPORTED_MODULE_0__.RR),
...
/* harmony export */   xB: () => (/* reexport safe */ _output_github_checks_js__WEBPACK_IMPORTED_MODULE_0__.xB)
/* harmony export */ });
...
function parseOutputSchemaVersionInput(value) {
...
/* harmony export */   pC: () => (/* binding */ toFindingFromV2),
/* harmony export */   rQ: () => (/* binding */ skillExecutionIdByNameFrom)
/* harmony export */ });
/* unused harmony exports SeverityBreakdownSchema, SkippedTriggerReasonSchema, TriggerRunResultV2Schema, SkillExecutionSchema, ExportedFindingV2Schema, DiscardedFindingSchema, DedupeDetailV2Schema, FindingObservationV2Schema, reconstructSkillReportsFromV2 */
/* harmony import */ var zod__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(53391);
/* harmony import */ var _types_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(78481);
...
/* harmony import */ var _output_github_checks_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(138);
/* harmony import */ var _utils_version_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(56317);
/* harmony import */ var _cli_output_formatters_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(43171);
...
const SeverityBreakdownSchema = zod__WEBPACK_IMPORTED_MODULE_7__/* .object */ .Ik({
    high: zod__WEBPACK_IMPORTED_MODULE_7__/* .number */ .ai().int().nonnegative(),
    medium: zod__WEBPACK_IMPORTED_MODULE_7__/* .number */ .ai().int().nonnegative(),
    low: zod__WEBPACK_IMPORTED_MODULE_7__/* .number */ .ai().int().nonnegative(),
});
const HarnessSchema = zod__WEBPACK_IMPORTED_MODULE_7__/* .object */ .Ik({
    name: zod__WEBPACK_IMPORTED_MODULE_7__/* .literal */ .eu('warden'),
    version: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj(),
    actionRef: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().optional(),
});
const RepositorySchema = zod__WEBPACK_IMPORTED_MODULE_7__/* .object */ .Ik({
    owner: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj(),
    name: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj(),
    fullName: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj(),
});
const PullRequestEnvelopeSchema = zod__WEBPACK_IMPORTED_MODULE_7__/* .object */ .Ik({
    number: zod__WEBPACK_IMPORTED_MODULE_7__/* .number */ .ai().int(),
    author: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj(),
    title: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj(),
    baseBranch: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj(),
    headBranch: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj(),
    headSha: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj(),
});
const ConfiguredSkillSchema = zod__WEBPACK_IMPORTED_MODULE_7__/* .object */ .Ik({
    name: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj(),
    triggered: zod__WEBPACK_IMPORTED_MODULE_7__/* .boolean */ .zM(),
});
const SkippedTriggerReasonSchema = zod__WEBPACK_IMPORTED_MODULE_7__/* ["enum"] */ .k5([
    'no_event_match',
    'path_filter',
    'draft_state',
    'label_mismatch',
...
const SkippedTriggerSchema = zod__WEBPACK_IMPORTED_MODULE_7__/* .object */ .Ik({
    skillName: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj(),
    triggerId: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().optional(),
    triggerName: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().optional(),
    reason: SkippedTriggerReasonSchema,
});
const TriggerErrorSchema = zod__WEBPACK_IMPORTED_MODULE_7__/* .object */ .Ik({
    name: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().optional(),
    message: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj(),
});
const TriggerRunResultV2Schema = zod__WEBPACK_IMPORTED_MODULE_7__/* .discriminatedUnion */ .gM('status', [
    zod__WEBPACK_IMPORTED_MODULE_7__/* .object */ .Ik({
        status: zod__WEBPACK_IMPORTED_MODULE_7__/* .literal */ .eu('success'),
        triggerId: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().optional(),
        triggerName: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj(),
        skillName: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj(),
    }),
    zod__WEBPACK_IMPORTED_MODULE_7__/* .object */ .Ik({
        status: zod__WEBPACK_IMPORTED_MODULE_7__/* .literal */ .eu('error'),
        triggerId: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().optional(),
        triggerName: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj(),
        skillName: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj(),
...
const ResolvedDefaultsSchema = zod__WEBPACK_IMPORTED_MODULE_7__/* .object */ .Ik({
    ...
    model: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().optional(),
    auxiliaryModel: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().optional(),
    synthesisModel: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().optional(),
    runtime: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().optional(),
    verifyFindings: zod__WEBPACK_IMPORTED_MODULE_7__/* .boolean */ .zM().optional(),
    failCheck: zod__WEBPACK_IMPORTED_MODULE_7__/* .boolean */ .zM().optional(),
    requestChanges: zod__WEBPACK_IMPORTED_MODULE_7__/* .boolean */ .zM().optional(),
    maxFindings: zod__WEBPACK_IMPORTED_MODULE_7__/* .number */ .ai().int().nonnegative().optional(),
});
const WardenMetadataSchema = zod__WEBPACK_IMPORTED_MODULE_7__/* .object */ .Ik({
    schemaVersion: zod__WEBPACK_IMPORTED_MODULE_7__/* .literal */ .eu('2'),
    runId: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj(),
    runAttempt: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().optional(),
    generatedAt: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().datetime(),
    ...
    configuredSkills: zod__WEBPACK_IMPORTED_MODULE_7__/* .array */ .YO(ConfiguredSkillSchema).optional(),
    skippedTriggers: zod__WEBPACK_IMPORTED_MODULE_7__/* .array */ .YO(SkippedTriggerSchema).optional(),
    triggerResults: zod__WEBPACK_IMPORTED_MODULE_7__/* .array */ .YO(TriggerRunResultV2Schema).optional(),
    resolvedDefaults: ResolvedDefaultsSchema.optional(),
});
const AuxiliaryUsageEntrySchema = zod__WEBPACK_IMPORTED_MODULE_7__/* .object */ .Ik({
    agent: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj(),
    model: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().optional(),
    runtime: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().optional(),
    usage: _types_index_js__WEBPACK_IMPORTED_MODULE_0__/* .UsageStatsSchema */ .Ur,
});
const SkillExecutionSchema = zod__WEBPACK_IMPORTED_MODULE_7__/* .object */ .Ik({
    skillExecutionId: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj(),
    skillName: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj(),
    triggerId: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().optional(),
    triggerName: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().optional(),
    model: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().optional(),
    models: zod__WEBPACK_IMPORTED_MODULE_7__/* .array */ .YO(zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj()).optional(),
    runtime: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().optional(),
    auxiliaryModel: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().optional(),
    synthesisModel: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().optional(),
    summary: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj(),
    durationMs: zod__WEBPACK_IMPORTED_MODULE_7__/* .number */ .ai().nonnegative().optional(),
    usage: _types_index_js__WEBPACK_IMPORTED_MODULE_0__/* .UsageStatsSchema */ .Ur.optional(),
    auxiliaryUsage: zod__WEBPACK_IMPORTED_MODULE_7__/* .array */ .YO(AuxiliaryUsageEntrySchema).optional(),
    findingsBySeverity: SeverityBreakdownSchema,
    findingIds: zod__WEBPACK_IMPORTED_MODULE_7__/* .array */ .YO(zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj()),
    failedHunks: zod__WEBPACK_IMPORTED_MODULE_7__/* .number */ .ai().int().nonnegative().optional(),
    failedExtractions: zod__WEBPACK_IMPORTED_MODULE_7__/* .number */ .ai().int().nonnegative().optional(),
    ...
    checkRunUrl: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().optional(),
    checkRunId: zod__WEBPACK_IMPORTED_MODULE_7__/* .number */ .ai().int().positive().optional(),
    reviewEvent: zod__WEBPACK_IMPORTED_MODULE_7__/* ["enum"] */ .k5(['APPROVE', 'REQUEST_CHANGES', 'COMMENT']).optional(),
    checkConclusion: zod__WEBPACK_IMPORTED_MODULE_7__/* ["enum"] */ .k5(['success', 'failure', 'neutral', 'cancelled']).optional(),
    issueNumber: zod__WEBPACK_IMPORTED_MODULE_7__/* .number */ .ai().int().positive().optional(),
    issueUrl: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().optional(),
});
const FindingSnapshotSchema = zod__WEBPACK_IMPORTED_MODULE_7__/* .object */ .Ik({
    title: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj(),
    description: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj(),
...
const VerificationStageSchema = zod__WEBPACK_IMPORTED_MODULE_7__/* .discriminatedUnion */ .gM('outcome', [
    zod__WEBPACK_IMPORTED_MODULE_7__/* .object */ .Ik({
        outcome: zod__WEBPACK_IMPORTED_MODULE_7__/* .literal */ .eu('kept'),
        model: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().optional(),
        runtime: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().optional(),
    }),
    zod__WEBPACK_IMPORTED_MODULE_7__/* .object */ .Ik({
        outcome: zod__WEBPACK_IMPORTED_MODULE_7__/* .literal */ .eu('revised'),
        model: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().optional(),
        runtime: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().optional(),
        evidence: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().optional(),
        before: FindingSnapshotSchema,
    }),
]);
const MergeStageSchema = zod__WEBPACK_IMPORTED_MODULE_7__/* .object */ .Ik({
    model: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().optional(),
    runtime: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().optional(),
    absorbedFindingIds: zod__WEBPACK_IMPORTED_MODULE_7__/* .array */ .YO(zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj()),
});
const FindingProvenanceSchema = zod__WEBPACK_IMPORTED_MODULE_7__/* .object */ .Ik({
    originSkillExecutionId: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj(),
    originModel: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().optional(),
    verification: VerificationStageSchema.optional(),
    merge: MergeStageSchema.optional(),
});
const FindingAttributionSchema = zod__WEBPACK_IMPORTED_MODULE_7__/* .object */ .Ik({
    skillExecutionId: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj(),
    skillName: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj(),
    role: zod__WEBPACK_IMPORTED_MODULE_7__/* ["enum"] */ .k5(['primary', 'corroborating']),
    matchType: zod__WEBPACK_IMPORTED_MODULE_7__/* ["enum"] */ .k5(['hash', 'semantic']).optional(),
});
const ExportedFindingV2Schema = zod__WEBPACK_IMPORTED_MODULE_7__/* .object */ .Ik({
    id: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj(),
    reportedId: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().optional(),
    contentHash: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj(),
    severity: _types_index_js__WEBPACK_IMPORTED_MODULE_0__/* .SeveritySchema */ .Rc,
    confidence: _types_index_js__WEBPACK_IMPORTED_MODULE_0__/* .ConfidenceSchema */ .m3.optional(),
    title: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj(),
    description: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj(),
    verification: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().optional(),
    location: _types_index_js__WEBPACK_IMPORTED_MODULE_0__/* .LocationSchema */ .TH.optional(),
    additionalLocations: zod__WEBPACK_IMPORTED_MODULE_7__/* .array */ .YO(_types_index_js__WEBPACK_IMPORTED_MODULE_0__/* .LocationSchema */ .TH).optional(),
    sourceSnippet: _types_index_js__WEBPACK_IMPORTED_MODULE_0__/* .SourceSnippetSchema */ .Ot.optional(),
    reportedBy: zod__WEBPACK_IMPORTED_MODULE_7__/* .array */ .YO(FindingAttributionSchema).min(1),
    provenance: FindingProvenanceSchema,
    githubCommentId: zod__WEBPACK_IMPORTED_MODULE_7__/* .number */ .ai().int().positive().optional(),
    githubCommentUrl: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().optional(),
});
const DiscardedFindingSchema = zod__WEBPACK_IMPORTED_MODULE_7__/* .object */ .Ik({
    originSkillExecutionId: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj(),
    stage: zod__WEBPACK_IMPORTED_MODULE_7__/* ["enum"] */ .k5(['verification_rejected', 'merge_absorbed']),
    severity: _types_index_js__WEBPACK_IMPORTED_MODULE_0__/* .SeveritySchema */ .Rc,
    title: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj(),
    location: _types_index_js__WEBPACK_IMPORTED_MODULE_0__/* .LocationSchema */ .TH.optional(),
    model: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().optional(),
    reason: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().optional(),
    survivorFindingId: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().optional(),
});
const FindingOriginSchema = zod__WEBPACK_IMPORTED_MODULE_7__/* .object */ .Ik({
    skillExecutionId: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj(),
    skillName: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj(),
});
const DedupeDetailV2Schema = zod__WEBPACK_IMPORTED_MODULE_7__/* .object */ .Ik({
    source: zod__WEBPACK_IMPORTED_MODULE_7__/* ["enum"] */ .k5(['warden', 'external']),
    matchType: zod__WEBPACK_IMPORTED_MODULE_7__/* ["enum"] */ .k5(['hash', 'semantic']),
    existingFindingId: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().optional(),
    existingSkillExecutionId: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().optional(),
    existingCommentId: zod__WEBPACK_IMPORTED_MODULE_7__/* .number */ .ai().int().positive().optional(),
    existingThreadId: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().optional(),
    existingResolved: zod__WEBPACK_IMPORTED_MODULE_7__/* .boolean */ .zM().optional(),
    existingSkills: zod__WEBPACK_IMPORTED_MODULE_7__/* .array */ .YO(zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj()).optional(),
    actor: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().optional(),
});
const ObservedFindingSchema = zod__WEBPACK_IMPORTED_MODULE_7__/* .object */ .Ik({
    id: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj(),
    reportedId: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj().optional(),
    severity: _types_index_js__WEBPACK_IMPORTED_MODULE_0__/* .SeveritySchema */ .Rc,
    confidence: _types_index_js__WEBPACK_IMPORTED_MODULE_0__/* .ConfidenceSchema */ .m3.optional(),
    ...
    description: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj(),
    location: _types_index_js__WEBPACK_IMPORTED_MODULE_0__/* .LocationSchema */ .TH.optional(),
    elapsedMs: zod__WEBPACK_IMPORTED_MODULE_7__/* .number */ .ai().nonnegative().optional(),
});
const FindingObservationV2Schema = zod__WEBPACK_IMPORTED_MODULE_7__/* .discriminatedUnion */ .gM('outcome', [
    zod__WEBPACK_IMPORTED_MODULE_7__/* .object */ .Ik({
        outcome: zod__WEBPACK_IMPORTED_MODULE_7__/* .literal */ .eu('posted'),
    ...
    zod__WEBPACK_IMPORTED_MODULE_7__/* .object */ .Ik({
        outcome: zod__WEBPACK_IMPORTED_MODULE_7__/* .literal */ .eu('deduped'),
        origin: FindingOriginSchema,
        finding: ObservedFindingSchema,
        dedupe: DedupeDetailV2Schema,
    }),
    zod__WEBPACK_IMPORTED_MODULE_7__/* .object */ .Ik({
        outcome: zod__WEBPACK_IMPORTED_MODULE_7__/* .literal */ .eu('skipped'),
        origin: FindingOriginSchema,
        finding: ObservedFindingSchema,
        skippedReason: zod__WEBPACK_IMPORTED_MODULE_7__/* ["enum"] */ .k5(['max_findings', 'duplicate_in_batch', 'no_inline_location']),
    }),
    zod__WEBPACK_IMPORTED_MODULE_7__/* .object */ .Ik({
        outcome: zod__WEBPACK_IMPORTED_MODULE_7__/* .literal */ .eu('resolved'),
        origin: FindingOriginSchema,
        finding: ObservedFindingSchema,
        resolvedReason: zod__WEBPACK_IMPORTED_MODULE_7__/* ["enum"] */ .k5(['fix_evaluation', 'stale_check']),
    }),
    zod__WEBPACK_IMPORTED_MODULE_7__/* .object */ .Ik({
        outcome: zod__WEBPACK_IMPORTED_MODULE_7__/* .literal */ .eu('failed'),
        origin: FindingOriginSchema,
        finding: ObservedFindingSchema,
    }),
]);
const SummarySchema = zod__WEBPACK_IMPORTED_MODULE_7__/* .object */ .Ik({
    totalFindings: zod__WEBPACK_IMPORTED_MODULE_7__/* .number */ .ai().int().nonnegative(),
    totalSkillExecutions: zod__WEBPACK_IMPORTED_MODULE_7__/* .number */ .ai().int().nonnegative(),
    bySeverity: SeverityBreakdownSchema,
    byOutcome: zod__WEBPACK_IMPORTED_MODULE_7__/* .object */ .Ik({
        posted: zod__WEBPACK_IMPORTED_MODULE_7__/* .number */ .ai().int().nonnegative(),
        deduped: zod__WEBPACK_IMPORTED_MODULE_7__/* .number */ .ai().int().nonnegative(),
        skipped: zod__WEBPACK_IMPORTED_MODULE_7__/* .number */ .ai().int().nonnegative(),
        resolved: zod__WEBPACK_IMPORTED_MODULE_7__/* .number */ .ai().int().nonnegative(),
        failed: zod__WEBPACK_IMPORTED_MODULE_7__/* .number */ .ai().int().nonnegative(),
    }),
});
const WardenFindingsSchemaV2 = zod__WEBPACK_IMPORTED_MODULE_7__/* .object */ .Ik({
    schemaVersion: zod__WEBPACK_IMPORTED_MODULE_7__/* .literal */ .eu('2'),
    runId: zod__WEBPACK_IMPORTED_MODULE_7__/* .string */ .Yj(),
    skillExecutions: zod__WEBPACK_IMPORTED_MODULE_7__/* .array */ .YO(SkillExecutionSchema),
    findings: zod__WEBPACK_IMPORTED_MODULE_7__/* .array */ .YO(ExportedFindingV2Schema),
    discardedFindings: zod__WEBPACK_IMPORTED_MODULE_7__/* .array */ .YO(DiscardedFindingSchema).optional(),
    findingObservations: zod__WEBPACK_IMPORTED_MODULE_7__/* .array */ .YO(FindingObservationV2Schema),
...
function buildMetadataOutputV2(context, resolvedTriggers, matchedTriggers, results, options) {
    ...
    const skippedTriggers = resolvedTriggers
        ...
        triggerId: t.id,
        triggerName: t.name,
        reason: pendingIds?.has(t.id) ? 'pending' : deriveSkippedReason(t, context),
    }));
    ...
    return WardenMetadataSchema.parse({
        ...
        harness: {
            name: 'warden',
            version: (0,_utils_version_js__WEBPACK_IMPORTED_MODULE_5__/* .getVersion */ .H)(),
 ...
 */
function resolveObservationSkillExecutionId(ownId, skillName, skillExecutionIdByName) {
 ...
 * rather than a guess.
 */
function resolveReportSkillExecutionId(ownId, skillName, skillExecutionIdByName) {
    return ownId ?? skillExecutionIdByName.get(skillName) ?? skillName;
}
function buildFindingObservationsV2(findingObservations, skillExecutionIdByName) {
...
function exactCorroborationKey(skillExecutionId, findingId) {
...
function buildCorroboratingAttributions(findingObservations, skillExecutionIdByName) {
    const exact = new Map();
    const heuristic = new Map();
    const ownAnchors = new Map();
    for (const observation of findingObservations) {
 ...
 * both passes.
 */
function resolveCorroboratingAttributions(candidates, findingId, ownFindingId, targetSkillName, targetSkillExecutionId, skillExecutionIdByName) {
    const seenSkillExecutionIds = new Set([targetSkillExecutionId]);
    const attributions = [];
    ...
    for (const attribution of exactMatches) {
        if (seenSkillExecutionIds.has(attribution.skillExecutionId))
            continue;
    ...
    if (skillExecutionIdByName.get(targetSkillName) === targetSkillExecutionId) {
        ...
        for (const candidate of heuristicMatches) {
            ...
            if (ownAnchor && anchorsConflict(ownAnchor, candidate.anchor))
                continue;
            if (seenSkillExecutionIds.has(candidate.attribution.skillExecutionId))
                continue;
 ...
 */
function buildReportedIdMap(findingObservations, skillExecutionIdByName) {
    const reportedIds = new Map();
    for (const observation of findingObservations) {
        if (observation.outcome !== 'deduped' || !observation.finding.reportedId)
            continue;
        const skillExecutionId = resolveObservationSkillExecutionId(observation.skillExecutionId, observation.skill, skillExecutionIdByName);
 ...
 */
function buildGithubCommentMap(findingObservations, skillExecutionIdByName) {
    const commentsById = new Map();
    for (const observation of findingObservations) {
        if (observation.outcome !== 'posted')
            continue;
        if (!observation.githubCommentId && !observation.githubCommentUrl)
            continue;
        const skillExecutionId = resolveObservationSkillExecutionId(observation.skillExecutionId, observation.skill, skillExecutionIdByName);
 ...
 */
function buildSkillExecutionUsageUpdates(results, triggerById, skillExecutionIdByName) {
 ...
 * does.
 */
function patchFindingsOutputV2Observations(base, results, matchedTriggers, findingObservations) {
    ...
    const findings = base.findings.map((original) => {
        ...
        const newCorroborators = resolveCorroboratingAttributions(corroboratingById, (0,_cli_output_formatters_js__WEBPACK_IMPORTED_MODULE_6__/* .displayFindingId */ .BP)(finding), finding.id, primarySkillName, originSkillExecutionId, skillExecutionIdByName);
...
function reduceFindingProcessingEvents(events, skillExecutionId) {
...
function buildFindingsOutputV2(results, matchedTriggers, findingObservations, options) {
    ...
    for (const result of results) {
        ...
        const trigger = result.triggerId ? triggerById.get(result.triggerId) : undefined;
        const skillExecutionId = resolveReportSkillExecutionId(trigger?.skillExecutionId, report.skill, skillExecutionIdByName);
        const { verificationById, mergeById, discarded } = reduceFindingProcessingEvents(result.findingProcessingEvents, skillExecutionId);
        ...
        skillExecutions.push({
            ...
            checkConclusion: (0,_output_github_checks_js__WEBPACK_IMPORTED_MODULE_4__/* .determineConclusion */ .Hx)((0,_types_index_js__WEBPACK_IMPORTED_MODULE_0__/* .filterFindings */ .Ni)(report.findings, undefined, result.minConfidence), result.failOn, result.failCheck),
        ...
        for (const finding of report.findings) {
            ...
            findings.push({
                ...
                reportedBy: [
                    ...
                    ...resolveCorroboratingAttributions(corroboratingById, (0,_cli_output_formatters_js__WEBPACK_IMPORTED_MODULE_6__/* .displayFindingId */ .BP)(finding), finding.id, report.skill, skillExecutionId, skillExecutionIdByName),
                ],
                provenance: {
                    originSkillExecutionId: skillExecutionId,
 ...
 */
function reconstructSkillReportsFromV2(findingsOutput) {
    ...
    return findingsOutput.skillExecutions.map((execution) => {
        ...
        const { usage: auxiliaryUsage, attribution: auxiliaryUsageAttribution } = fromAuxiliaryUsageEntries(execution.auxiliaryUsage);
        return {
...
const DedupeDetailSchema = schemas/* object */.Ik({
    ...
    existingSkillExecutionId: schemas/* string */.Yj().optional(),
...
const FindingObservationSchema = schemas/* discriminatedUnion */.gM('outcome', [
    schemas/* object */.Ik({
        ...
        githubCommentId: schemas/* number */.ai().int().positive().optional(),
        githubCommentUrl: schemas/* string */.Yj().optional(),
    }),
    schemas/* object */.Ik({
 ...
 * underlying Finding.
 */
function v1ContinuityId(finding) {
    return (0,formatters/* displayFindingId */.BP)(finding);
}
...
/* harmony import */ var _output_dedup_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(3941);
/* harmony import */ var _sdk_usage_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(44759);
/* harmony import */ var _sdk_extract_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(29709);
/* harmony import */ var _cli_output_tty_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(80029);
/**
 * Review Poster
 *
 ...
 */
function syncReportedIds(reportFindings, actions) {
    if (actions.length === 0) {
        return reportFindings;
    }
    const reportedIds = new Map(actions.filter((action) => action.finding.reportedId).map((action) => [action.finding.id, action.finding.reportedId]));
 ...
 */
function matchPostedCommentsToFindings(rendered, posted) {
...
async function postReviewToGitHub(octokit, context, result, feedbackGate) {
    ...
    try {
        ...
        (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_5__/* .warnAction */ .T6)(`Failed to fetch posted review comment ids: ${error}`);
        return { outcome: 'posted' };
    }
}
/**
    ...
    try {
        ...
        if (findingsToPost.length > 1) {
            ...
            if (consolidateResult.usage) {
                ...
                result.report.auxiliaryUsage = (0,_sdk_usage_js__WEBPACK_IMPORTED_MODULE_6__/* .mergeAuxiliaryUsage */ .wV)(result.report.auxiliaryUsage, consolidateAux);
                result.report.auxiliaryUsageAttribution = (0,_sdk_usage_js__WEBPACK_IMPORTED_MODULE_6__/* .mergeAuxiliaryUsageAttribution */ .vd)(result.report.auxiliaryUsageAttribution, { consolidate: { model: ctx.model, runtime: ctx.runtime } });
            }
            if (consolidateResult.removedCount > 0) {
                (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_5__/* .logAction */ .d5)(`Consolidated ${consolidateResult.removedCount} duplicate findings within batch for ${result.triggerName}`);
            }
        }
        ...
        if (existingComments.length > 0 && findingsToPost.length > 0) {
            ...
            if (dedupResult.dedupUsage) {
                ...
                result.report.auxiliaryUsage = (0,_sdk_usage_js__WEBPACK_IMPORTED_MODULE_6__/* .mergeAuxiliaryUsage */ .wV)(result.report.auxiliaryUsage, dedupAux);
                result.report.auxiliaryUsageAttribution = (0,_sdk_usage_js__WEBPACK_IMPORTED_MODULE_6__/* .mergeAuxiliaryUsageAttribution */ .vd)(result.report.auxiliaryUsageAttribution, { dedup: { model: ctx.model, runtime: ctx.runtime } });
            }
            if (dedupResult.duplicateActions.length > 0) {
                (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_5__/* .logAction */ .d5)(`Found ${dedupResult.duplicateActions.length} duplicate findings for ${result.triggerName}`);
            }
        ...
        if (dedupResult?.duplicateActions.length) {
            ...
            if (actionCounts.updated > 0) {
                (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_5__/* .logAction */ .d5)(`Updated ${actionCounts.updated} existing Warden comments with skill attribution`);
            }
            if (actionCounts.reacted > 0) {
                (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_5__/* .logAction */ .d5)(`Added reactions to ${actionCounts.reacted} existing external comments`);
            }
            if (actionCounts.failed > 0) {
                ...
                (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_5__/* .warnAction */ .T6)(message);
            }
        }
        ...
        if (findingsToPost.length > 0 || reportOnSuccess || needsRequestChanges) {
            ...
            let postResult = { outcome: 'no_review' };
            try {
                ...
                if (renderResultToPost.review?.event === 'REQUEST_CHANGES') {
                    (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_5__/* .warnAction */ .T6)(`Inline comments failed for ${result.triggerName}, posting findings in review body`);
                    ...
                    (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_5__/* .warnAction */ .T6)(`Inline comments failed for ${result.triggerName}, falling back to checks only`);
            ...
            for (const finding of postedFindings) {
                ...
                const comment = (0,_output_dedup_js__WEBPACK_IMPORTED_MODULE_3__/* .findingToExistingComment */ .Xi)(finding, skill, skillExecutionId);
                if (comment) {
        ...
        (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_5__/* .warnAction */ .T6)(`Failed to post review for ${result.triggerName}: ${error}`);
        return {
            posted: false,
            newComments,
            activeWardenCommentIds,
...
/* harmony export */   K0: () => (/* binding */ buildV2WriteOptions),
...
/* harmony export */   _j: () => (/* binding */ writeSchemaV2Output),
...
/* harmony export */   gD: () => (/* binding */ writeSchemaV2OutputLive),
/* harmony export */   qN: () => (/* binding */ writeSchemaV2OutputPair),
/* harmony export */   sl: () => (/* binding */ collectTriggerErrors),
/* harmony export */   u4: () => (/* binding */ writeFindingsOutputs),
/* harmony export */   uH: () => (/* binding */ setOutput),
/* harmony export */   wZ: () => (/* binding */ setWorkflowOutputs)
/* harmony export */ });
/* unused harmony exports findClaudeCodeExecutable, getFindingsOutputPath, getMetadataOutputPath, getFindingsOutputPathV2, writeSchemaV2OutputPairLive */
...
/* harmony import */ var _utils_fs_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(95994);
/* harmony import */ var _reporting_output_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(80961);
/* harmony import */ var _reporting_output_v2_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(88391);
/* harmony import */ var _triggers_matcher_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(49431);
/**
 * Workflow Base
 *
...
function computeWorkflowOutputs(reports) {
    return {
        ...
        highCount: (0,_triggers_matcher_js__WEBPACK_IMPORTED_MODULE_9__/* .countSeverity */ .jC)(reports, 'high'),
...
function writeFindingsOutput(reports, context, findingObservations = [], options = {}) {
    ...
    const output = (0,_reporting_output_js__WEBPACK_IMPORTED_MODULE_7__/* .buildFindingsOutput */ .Cs)(reports, context, findingObservations, {
 ...
 */
function writeFindingsOutputs(writeV1, writeV2, onFailure, onSuccess) {
    let failureMessage;
    try {
        const path = writeV1();
        onSuccess?.(path);
...
function writeFileAtomicJson(path, value) {
    (0,_utils_fs_js__WEBPACK_IMPORTED_MODULE_6__/* .writeFileAtomic */ .Z)(path, JSON.stringify(value, null, 2));
}
/**
 ...
 */
function writeSchemaV2OutputPair(metadata, findings, context) {
    ...
    (0,_utils_fs_js__WEBPACK_IMPORTED_MODULE_6__/* .writeFileAtomic */ .Z)(`${findingsPath}.done`, '');
 ...
 */
function writeSchemaV2OutputPairLive(metadata, findings, context) {
    try {
        const metadataPath = getMetadataOutputPath(context.repoPath);
        const findingsPath = getFindingsOutputPathV2(context.repoPath);
        writeFileAtomicJson(metadataPath, metadata);
...
function writeSchemaV2Output(context, resolvedTriggers, matchedTriggers, results, findingObservations, options) {
    const metadata = (0,_reporting_output_v2_js__WEBPACK_IMPORTED_MODULE_8__/* .buildMetadataOutputV2 */ .LE)(context, resolvedTriggers, matchedTriggers, results, options);
    const findings = (0,_reporting_output_v2_js__WEBPACK_IMPORTED_MODULE_8__/* .buildFindingsOutputV2 */ .WS)(results, matchedTriggers, findingObservations, { runId: options.runId });
...
function writeSchemaV2OutputLive(context, resolvedTriggers, matchedTriggers, results, findingObservations, options) {
    const metadata = (0,_reporting_output_v2_js__WEBPACK_IMPORTED_MODULE_8__/* .buildMetadataOutputV2 */ .LE)(context, resolvedTriggers, matchedTriggers, results, options);
    const findings = (0,_reporting_output_v2_js__WEBPACK_IMPORTED_MODULE_8__/* .buildFindingsOutputV2 */ .WS)(results, matchedTriggers, findingObservations, { runId: options.runId });
...
function buildV2WriteOptions(inputs) {
    return {
...
/* harmony import */ var _checks_manager_js__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(28865);
...
async function executeAllTriggers(matchedTriggers, context, runnerConcurrency, inputs, options = {}) {
    ...
    return (0,_utils_index_js__WEBPACK_IMPORTED_MODULE_9__/* .runPool */ .kD)(matchedTriggers, concurrency, (trigger) => (0,_triggers_executor_js__WEBPACK_IMPORTED_MODULE_13__/* .executeTrigger */ .k)(trigger, {
        ...
        try {
            options.onTriggerComplete?.(result);
        }
        catch { /* live output must never abort the pool */ }
        return result;
...
function writeSchemaV2Outputs(inputs, context, resolvedTriggers, matchedTriggers, results, findingObservations, onError) {
    if (inputs.outputSchemaVersion !== '2')
        return;
    try {
        const { metadataPath, findingsPath } = (0,_base_js__WEBPACK_IMPORTED_MODULE_19__/* .writeSchemaV2Output */ ._j)(context, resolvedTriggers, matchedTriggers, results, findingObservations, (0,_base_js__WEBPACK_IMPORTED_MODULE_19__/* .buildV2WriteOptions */ .K0)(inputs));
        (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_23__/* .logAction */ .d5)(`Metadata written to ${metadataPath}`);
        (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_23__/* .logAction */ .d5)(`Findings (v2) written to ${findingsPath}`);
    }
    catch (error) {
...
function writeSchemaV2OutputsLive(inputs, context, resolvedTriggers, matchedTriggers, results) {
    if (inputs.outputSchemaVersion !== '2')
        return;
    (0,_base_js__WEBPACK_IMPORTED_MODULE_19__/* .writeSchemaV2OutputLive */ .gD)(context, resolvedTriggers, matchedTriggers, results, [], (0,_base_js__WEBPACK_IMPORTED_MODULE_19__/* .buildV2WriteOptions */ .K0)(inputs));
}
/**
 ...
 */
function writeSchemaV2ReportOutputs(metadataOutputV2, findingsOutputV2, context, results, matchedTriggers, findingObservations, onError) {
    if (!metadataOutputV2 || !findingsOutputV2)
        return;
    try {
        const patched = (0,_reporting_output_v2_js__WEBPACK_IMPORTED_MODULE_22__/* .patchFindingsOutputV2Observations */ .V6)(findingsOutputV2, results, matchedTriggers, findingObservations);
        const { metadataPath, findingsPath } = (0,_base_js__WEBPACK_IMPORTED_MODULE_19__/* .writeSchemaV2OutputPair */ .qN)(metadataOutputV2, patched, context);
        (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_23__/* .logAction */ .d5)(`Metadata written to ${metadataPath}`);
        (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_23__/* .logAction */ .d5)(`Findings (v2) written to ${findingsPath}`);
    }
    catch (error) {
...
async function finalizeWorkflow(octokit, context, previousReviewInfo, coreCheckId, results, reports, findingObservations, shouldFailAction, failureReasons, canResolveStale, gate, triggerErrors, matchedTriggers, resolvedTriggers, inputs) {
    ...
    (0,_base_js__WEBPACK_IMPORTED_MODULE_19__/* .writeFindingsOutputs */ .u4)(() => (0,_base_js__WEBPACK_IMPORTED_MODULE_19__/* .writeFindingsOutput */ .JR)(reports, context, findingObservations, {
    ...
    }), () => writeSchemaV2Outputs(inputs, context, resolvedTriggers, matchedTriggers, results, findingObservations, _cli_output_tty_js__WEBPACK_IMPORTED_MODULE_23__/* .warnAction */ .T6), _cli_output_tty_js__WEBPACK_IMPORTED_MODULE_23__/* .warnAction */ .T6, (path) => (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_23__/* .logAction */ .d5)(`Findings written to ${path}`));
...
function buildReplayBaseResult(trigger, inputs) {
    return {
        triggerId: trigger.id,
        triggerName: trigger.name,
        skillName: trigger.skill,
...
async function createCompletedSkillChecksForReport(octokit, context, results) {
    ...
    for (const result of results) {
        ...
        const failedCheck = await (0,_checks_manager_js__WEBPACK_IMPORTED_MODULE_18__/* .createFailedSkillCheck */ .xB)(octokit, result.skillName, result.error ?? new Error('Trigger did not produce a report'), options);
...
async function finalizeReportWorkflow(octokit, context, previousReviewInfo, results, reports, findingObservations, shouldFailAction, failureReasons, canResolveStale, gate, triggerErrors, options) {
    ...
    }), () => writeSchemaV2ReportOutputs(options.metadataOutputV2, options.findingsOutputV2, context, results, options.matchedTriggers, findingObservations, _cli_output_tty_js__WEBPACK_IMPORTED_MODULE_23__/* .warnAction */ .T6), _cli_output_tty_js__WEBPACK_IMPORTED_MODULE_23__/* .warnAction */ .T6, (path) => (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_23__/* .logAction */ .d5)(`Findings written to ${path}`));
...
async function runAnalyzeMode(inputs, initResult, span) {
    ...
    if (skipCoreCheck || matchedTriggers.length === 0) {
        ...
        (0,_base_js__WEBPACK_IMPORTED_MODULE_19__/* .writeFindingsOutputs */ .u4)(() => (0,_base_js__WEBPACK_IMPORTED_MODULE_19__/* .writeFindingsOutput */ .JR)([], context, [], {
            triggerResults: [],
            configuredSkills: (0,_reporting_output_js__WEBPACK_IMPORTED_MODULE_21__/* .buildConfiguredSkillsList */ .BA)({ allTriggers: resolvedTriggers, matchedTriggers }),
        }), () => writeSchemaV2Outputs(inputs, context, resolvedTriggers, matchedTriggers, [], [], _base_js__WEBPACK_IMPORTED_MODULE_19__/* .setFailed */ .C1), _base_js__WEBPACK_IMPORTED_MODULE_19__/* .setFailed */ .C1, (path) => (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_23__/* .logAction */ .d5)(`Findings written to ${path}`));
    ...
    (0,_base_js__WEBPACK_IMPORTED_MODULE_19__/* .writeFindingsOutputs */ .u4)(() => (0,_base_js__WEBPACK_IMPORTED_MODULE_19__/* .writeFindingsOutput */ .JR)(reports, context, [], {
        triggerResults: toReplayTriggerResults(results),
        configuredSkills: (0,_reporting_output_js__WEBPACK_IMPORTED_MODULE_21__/* .buildConfiguredSkillsList */ .BA)({ allTriggers: resolvedTriggers, matchedTriggers }),
    }), () => writeSchemaV2Outputs(inputs, context, resolvedTriggers, matchedTriggers, results, [], _base_js__WEBPACK_IMPORTED_MODULE_19__/* .setFailed */ .C1), _base_js__WEBPACK_IMPORTED_MODULE_19__/* .setFailed */ .C1, (path) => (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_23__/* .logAction */ .d5)(`Findings written to ${path}`));
...
function buildReportModeResultsV2(metadata, findingsOutput, matchedTriggers, inputs) {
    ...
    const results = matchedTriggers.map((trigger) => {
        ...
        const findings = execution.findingIds.flatMap((id) => {
            const finding = findingsByExecutionScopedId.get(`${execution.skillExecutionId}:${id}`);
            return finding ? [(0,_reporting_output_v2_js__WEBPACK_IMPORTED_MODULE_22__/* .toFindingFromV2 */ .pC)(finding)] : [];
        });
    ...
    try {
        ...
        if (skipCoreCheck) {
            ...
            (0,_base_js__WEBPACK_IMPORTED_MODULE_19__/* .writeFindingsOutputs */ .u4)(() => (0,_base_js__WEBPACK_IMPORTED_MODULE_19__/* .writeFindingsOutput */ .JR)([], context, [], {
                triggerResults: [],
                configuredSkills: (0,_reporting_output_js__WEBPACK_IMPORTED_MODULE_21__/* .buildConfiguredSkillsList */ .BA)({ allTriggers: resolvedTriggers, matchedTriggers }),
            }), () => writeSchemaV2ReportOutputs(metadataOutputV2, findingsOutputV2, context, [], matchedTriggers, [], _cli_output_tty_js__WEBPACK_IMPORTED_MODULE_23__/* .warnAction */ .T6), _cli_output_tty_js__WEBPACK_IMPORTED_MODULE_23__/* .warnAction */ .T6, (path) => (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_23__/* .logAction */ .d5)(`Findings written to ${path}`));
        ...
        if (matchedTriggers.length === 0) {
            ...
            (0,_base_js__WEBPACK_IMPORTED_MODULE_19__/* .setWorkflowOutputs */ .wZ)(outputs);
            (0,_base_js__WEBPACK_IMPORTED_MODULE_19__/* .writeFindingsOutputs */ .u4)(() => (0,_base_js__WEBPACK_IMPORTED_MODULE_19__/* .writeFindingsOutput */ .JR)([], context, cleanupFindingObservations, {
                triggerResults: [],
                configuredSkills: (0,_reporting_output_js__WEBPACK_IMPORTED_MODULE_21__/* .buildConfiguredSkillsList */ .BA)({ allTriggers: resolvedTriggers, matchedTriggers }),
            }), () => writeSchemaV2ReportOutputs(metadataOutputV2, findingsOutputV2, context, [], matchedTriggers, cleanupFindingObservations, _cli_output_tty_js__WEBPACK_IMPORTED_MODULE_23__/* .warnAction */ .T6), _cli_output_tty_js__WEBPACK_IMPORTED_MODULE_23__/* .warnAction */ .T6, (path) => (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_23__/* .logAction */ .d5)(`Findings written to ${path}`));
            await createCompletedCoreCheckForReport(octokit, context, [], [], false, outputs, {
...
async function runPRWorkflow(octokit, inputs, eventName, eventPath, repoPath) {
    return _sentry_js__WEBPACK_IMPORTED_MODULE_2__/* .Sentry.startSpan */ .sQ.startSpan({ op: 'workflow.run', name: 'review pull_request' }, async (span) => {
        ...
        if (skipCoreCheck) {
            ...
            (0,_base_js__WEBPACK_IMPORTED_MODULE_19__/* .writeFindingsOutputs */ .u4)(() => (0,_base_js__WEBPACK_IMPORTED_MODULE_19__/* .writeFindingsOutput */ .JR)([], context, [], {
                configuredSkills: (0,_reporting_output_js__WEBPACK_IMPORTED_MODULE_21__/* .buildConfiguredSkillsList */ .BA)({ allTriggers: resolvedTriggers, matchedTriggers }),
            }), () => writeSchemaV2Outputs(inputs, context, resolvedTriggers, matchedTriggers, [], [], _cli_output_tty_js__WEBPACK_IMPORTED_MODULE_23__/* .warnAction */ .T6), _cli_output_tty_js__WEBPACK_IMPORTED_MODULE_23__/* .warnAction */ .T6);
        ...
        if (matchedTriggers.length === 0) {
            await runOrFailCore(octokit, context, coreCheckId, async () => {
                ...
                (0,_base_js__WEBPACK_IMPORTED_MODULE_19__/* .writeFindingsOutputs */ .u4)(() => (0,_base_js__WEBPACK_IMPORTED_MODULE_19__/* .writeFindingsOutput */ .JR)([], context, cleanupFindingObservations, {
                    configuredSkills: (0,_reporting_output_js__WEBPACK_IMPORTED_MODULE_21__/* .buildConfiguredSkillsList */ .BA)({ allTriggers: resolvedTriggers, matchedTriggers }),
                }), () => writeSchemaV2Outputs(inputs, context, resolvedTriggers, matchedTriggers, [], cleanupFindingObservations, _cli_output_tty_js__WEBPACK_IMPORTED_MODULE_23__/* .warnAction */ .T6), _cli_output_tty_js__WEBPACK_IMPORTED_MODULE_23__/* .warnAction */ .T6);
...
function writeSchemaV2ScheduleOutputs(inputs, context, resolvedTriggers, matchedTriggers, results) {
    if (inputs.outputSchemaVersion !== '2')
        return;
    try {
        const { metadataPath, findingsPath } = (0,_base_js__WEBPACK_IMPORTED_MODULE_9__/* .writeSchemaV2Output */ ._j)(context, resolvedTriggers, matchedTriggers, results, [], (0,_base_js__WEBPACK_IMPORTED_MODULE_9__/* .buildV2WriteOptions */ .K0)(inputs));
 ...
 */
function writeSchemaV2ScheduleOutputsLive(inputs, context, resolvedTriggers, matchedTriggers, results, processedTriggerIds) {
    if (inputs.outputSchemaVersion !== '2')
        return;
    const pendingTriggerIds = new Set(resolvedTriggers
        .filter((t) => t.type === 'schedule' && !processedTriggerIds.has(t.id))
        .map((t) => t.id));
    (0,_base_js__WEBPACK_IMPORTED_MODULE_9__/* .writeSchemaV2OutputLive */ .gD)(context, resolvedTriggers, matchedTriggers, results, [], {
        ...(0,_base_js__WEBPACK_IMPORTED_MODULE_9__/* .buildV2WriteOptions */ .K0)(inputs),
        pendingTriggerIds,
    });
}
...
async function runScheduleWorkflowInner(octokit, inputs, repoPath, workflowSpan) {
    ...
    try {
        ...
        if (error instanceof _config_loader_js__WEBPACK_IMPORTED_MODULE_0__/* .ConfigLoadError */ .tx &&
            ...
            (0,_base_js__WEBPACK_IMPORTED_MODULE_9__/* .writeFindingsOutputs */ .u4)(() => (0,_base_js__WEBPACK_IMPORTED_MODULE_9__/* .writeFindingsOutput */ .JR)([], emptyContext, [], { configuredSkills: [] }), () => writeSchemaV2ScheduleOutputs(inputs, emptyContext, [], [], []), (message) => console.error(`::warning::${message}`));
            return;
        }
        throw error;
    }
    ...
    if (scheduleTriggers.length === 0) {
        ...
        (0,_base_js__WEBPACK_IMPORTED_MODULE_9__/* .writeFindingsOutputs */ .u4)(() => (0,_base_js__WEBPACK_IMPORTED_MODULE_9__/* .writeFindingsOutput */ .JR)([], emptyContext, [], {
        ...
        }), () => writeSchemaV2ScheduleOutputs(inputs, emptyContext, allResolvedTriggers, [], []), (message) => console.error(`::warning::${message}`));
        return;
    }
    ...
    for (const resolved of scheduleTriggers) {
        ...
        try {
            ...
            try {
                issueResult = await (0,_output_github_issues_js__WEBPACK_IMPORTED_MODULE_4__/* .createOrUpdateIssue */ .w)(octokit, owner, repo, [report], {
                    title: issueTitle,
                    commitSha: headSha,
                });
            }
            ...
            writeSchemaV2ScheduleOutputsLive(inputs, scheduleContext, allResolvedTriggers, matchedTriggers, results, processedTriggerIds);
            totalFindings += report.findings.length;
    ...
    // Write structured findings to file for external export (GCS, S3, etc.)
    (0,_base_js__WEBPACK_IMPORTED_MODULE_9__/* .writeFindingsOutputs */ .u4)(() => (0,_base_js__WEBPACK_IMPORTED_MODULE_9__/* .writeFindingsOutput */ .JR)(allReports, scheduleContext, [], {
        configuredSkills: (0,_reporting_output_js__WEBPACK_IMPORTED_MODULE_10__/* .buildConfiguredSkillsList */ .BA)({ allTriggers: allResolvedTriggers, matchedTriggers }),
    }), () => writeSchemaV2ScheduleOutputs(inputs, scheduleContext, allResolvedTriggers, matchedTriggers, results), (message) => console.error(`::warning::${message}`), (path) => console.log(`Findings written to ${path}`));
...
/* harmony export */   BP: () => (/* binding */ displayFindingId),
...
function displayFindingId(finding) {
...
async function runSkillTask(options, fileConcurrency, callbacks, semaphore) {
    ...
    return _sentry_js__WEBPACK_IMPORTED_MODULE_0__/* .Sentry.startSpan */ .sQ.startSpan({ op: 'skill.run', name: `run ${displayName}` }, async (span) => {
        ...
        try {
            ...
            resolvedModels = (0,_sdk_runner_js__WEBPACK_IMPORTED_MODULE_2__/* .uniqueResponseModels */ .dt)(allResponseModels);
 ...
 */
function findingToExistingComment(finding, skill, skillExecutionId) {
    if (!finding.location) {
        return null;
    }
    return {
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   $R: () => (/* binding */ createCompletedSkillCheck),
...
/* harmony export */   RR: () => (/* binding */ createCompletedCoreCheck),
...
/* harmony export */   xB: () => (/* binding */ createFailedSkillCheck)
/* harmony export */ });
        ...
        if (finding.additionalLocations) {
            for (const loc of finding.additionalLocations) {
                ...
                annotations.push({
                    ...
                    annotation_level: severityToAnnotationLevel(finding.severity),
                    message: (0,_utils_index_js__WEBPACK_IMPORTED_MODULE_2__/* .escapeHtml */ .ZD)(finding.description),
                    title: `[${(0,_cli_output_formatters_js__WEBPACK_IMPORTED_MODULE_1__/* .displayFindingId */ .BP)(finding)}] ${(0,_utils_index_js__WEBPACK_IMPORTED_MODULE_2__/* .escapeHtml */ .ZD)(finding.title)} (additional location)`,
                });
            }
        }
    }
...
function renderStatsFooter(durationMs, usage, auxiliaryUsage) {
    const total = (0,_cli_output_formatters_js__WEBPACK_IMPORTED_MODULE_1__/* .totalUsageStats */ .Dc)(usage, auxiliaryUsage);
    ...
    if (total) {
        parts.push(`${(0,_cli_output_formatters_js__WEBPACK_IMPORTED_MODULE_1__/* .formatTokens */ ._y)(total.inputTokens)} in / ${(0,_cli_output_formatters_js__WEBPACK_IMPORTED_MODULE_1__/* .formatTokens */ ._y)(total.outputTokens)} out`);
        parts.push((0,_cli_output_formatters_js__WEBPACK_IMPORTED_MODULE_1__/* .formatCost */ .BD)(total.costUSD));
    }
...
function renderFindingItem(finding, ctx) {
    ...
    let line = `- \`${(0,formatters/* displayFindingId */.BP)(finding)}\` **${(0,utils/* escapeHtml */.ZD)(finding.title)}**${locationStr} · ${finding.severity}`;
...
function renderReview(findings, report, failOn, allFindings, requestChanges) {
    ...
    const comments = findingsWithLocation.map((finding) => {
        ...
        body += `\n\n${renderAttributionFooter(report.skill, (0,_cli_output_formatters_js__WEBPACK_IMPORTED_MODULE_1__/* .displayFindingId */ .BP)(finding))}`;
...
function renderFindingItem(finding) {
    ...
    const extra = finding.additionalLocations?.length
        ...
        : '';
    return `- \`${(0,_cli_output_formatters_js__WEBPACK_IMPORTED_MODULE_1__/* .displayFindingId */ .BP)(finding)}\` **${(0,_utils_index_js__WEBPACK_IMPORTED_MODULE_3__/* .escapeHtml */ .ZD)(finding.title)}**${location}${extra} · ${finding.severity}: ${(0,_utils_index_js__WEBPACK_IMPORTED_MODULE_3__/* .escapeHtml */ .ZD)(finding.description)}`;
}
...
/* harmony import */ var _utils_index_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(82272);
...
async function runSkillAnalysis(skill, context, options = {}) {
    ...
    const report = {
        ...
        usage: totalUsage,
        durationMs: Date.now() - startTime,
        model: (0,_usage_js__WEBPACK_IMPORTED_MODULE_12__/* .resolveResponseModel */ .X5)(allResponseModels, options.model),
        models: (0,_usage_js__WEBPACK_IMPORTED_MODULE_12__/* .uniqueResponseModels */ .dt)(allResponseModels),
...
/* harmony export */   dt: () => (/* reexport safe */ _usage_js__WEBPACK_IMPORTED_MODULE_3__.dt),
