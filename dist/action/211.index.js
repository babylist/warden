        ...
        if (finding.additionalLocations) {
            for (const loc of finding.additionalLocations) {
                ...
                annotations.push({
                    ...
                    annotation_level: severityToAnnotationLevel(finding.severity),
                    message: (0,utils/* escapeHtml */.ZD)(finding.description),
                    title: `[${(0,formatters/* displayFindingId */.BP)(finding)}] ${(0,utils/* escapeHtml */.ZD)(finding.title)} (additional location)`,
                });
            }
        }
    }
...
/* harmony import */ var _cli_output_formatters_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(43171);
...
const SeverityBreakdownSchema = zod__WEBPACK_IMPORTED_MODULE_6__/* .object */ .Ik({
...
const HarnessSchema = zod__WEBPACK_IMPORTED_MODULE_6__/* .object */ .Ik({
    name: zod__WEBPACK_IMPORTED_MODULE_6__/* .literal */ .eu('warden'),
    version: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj(),
    actionRef: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj().optional(),
});
const RepositorySchema = zod__WEBPACK_IMPORTED_MODULE_6__/* .object */ .Ik({
    owner: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj(),
    name: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj(),
    fullName: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj(),
});
const PullRequestEnvelopeSchema = zod__WEBPACK_IMPORTED_MODULE_6__/* .object */ .Ik({
    number: zod__WEBPACK_IMPORTED_MODULE_6__/* .number */ .ai().int(),
    author: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj(),
    title: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj(),
    baseBranch: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj(),
    headBranch: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj(),
    headSha: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj(),
});
const ConfiguredSkillSchema = zod__WEBPACK_IMPORTED_MODULE_6__/* .object */ .Ik({
    name: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj(),
    triggered: zod__WEBPACK_IMPORTED_MODULE_6__/* .boolean */ .zM(),
});
const SkippedTriggerReasonSchema = zod__WEBPACK_IMPORTED_MODULE_6__/* ["enum"] */ .k5([
    'no_event_match',
    'path_filter',
    'draft_state',
    'label_mismatch',
...
const SkippedTriggerSchema = zod__WEBPACK_IMPORTED_MODULE_6__/* .object */ .Ik({
    skillName: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj(),
    triggerId: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj().optional(),
    triggerName: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj().optional(),
    reason: SkippedTriggerReasonSchema,
});
const TriggerErrorSchema = zod__WEBPACK_IMPORTED_MODULE_6__/* .object */ .Ik({
    name: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj().optional(),
    message: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj(),
});
const TriggerRunResultV2Schema = zod__WEBPACK_IMPORTED_MODULE_6__/* .discriminatedUnion */ .gM('status', [
    zod__WEBPACK_IMPORTED_MODULE_6__/* .object */ .Ik({
        status: zod__WEBPACK_IMPORTED_MODULE_6__/* .literal */ .eu('success'),
        triggerId: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj().optional(),
        triggerName: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj(),
        skillName: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj(),
    }),
    zod__WEBPACK_IMPORTED_MODULE_6__/* .object */ .Ik({
        status: zod__WEBPACK_IMPORTED_MODULE_6__/* .literal */ .eu('error'),
        triggerId: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj().optional(),
        triggerName: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj(),
        skillName: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj(),
...
const ResolvedDefaultsSchema = zod__WEBPACK_IMPORTED_MODULE_6__/* .object */ .Ik({
    ...
    auxiliaryModel: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj().optional(),
    synthesisModel: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj().optional(),
    runtime: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj().optional(),
    verifyFindings: zod__WEBPACK_IMPORTED_MODULE_6__/* .boolean */ .zM().optional(),
});
const WardenMetadataSchema = zod__WEBPACK_IMPORTED_MODULE_6__/* .object */ .Ik({
    schemaVersion: zod__WEBPACK_IMPORTED_MODULE_6__/* .literal */ .eu('2'),
    runId: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj(),
    runAttempt: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj().optional(),
    generatedAt: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj().datetime(),
    ...
    configuredSkills: zod__WEBPACK_IMPORTED_MODULE_6__/* .array */ .YO(ConfiguredSkillSchema).optional(),
    skippedTriggers: zod__WEBPACK_IMPORTED_MODULE_6__/* .array */ .YO(SkippedTriggerSchema).optional(),
    triggerResults: zod__WEBPACK_IMPORTED_MODULE_6__/* .array */ .YO(TriggerRunResultV2Schema).optional(),
    resolvedDefaults: ResolvedDefaultsSchema.optional(),
});
const AuxiliaryUsageEntrySchema = zod__WEBPACK_IMPORTED_MODULE_6__/* .object */ .Ik({
    agent: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj(),
    model: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj().optional(),
    runtime: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj().optional(),
    usage: _types_index_js__WEBPACK_IMPORTED_MODULE_0__/* .UsageStatsSchema */ .Ur,
});
const SkillExecutionSchema = zod__WEBPACK_IMPORTED_MODULE_6__/* .object */ .Ik({
    skillExecutionId: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj(),
    skillName: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj(),
    triggerId: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj().optional(),
    triggerName: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj().optional(),
    model: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj().optional(),
    ...
    auxiliaryModel: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj().optional(),
    synthesisModel: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj().optional(),
    summary: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj(),
    durationMs: zod__WEBPACK_IMPORTED_MODULE_6__/* .number */ .ai().nonnegative().optional(),
    usage: _types_index_js__WEBPACK_IMPORTED_MODULE_0__/* .UsageStatsSchema */ .Ur.optional(),
    auxiliaryUsage: zod__WEBPACK_IMPORTED_MODULE_6__/* .array */ .YO(AuxiliaryUsageEntrySchema).optional(),
    findingsBySeverity: SeverityBreakdownSchema,
    findingIds: zod__WEBPACK_IMPORTED_MODULE_6__/* .array */ .YO(zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj()),
    failedHunks: zod__WEBPACK_IMPORTED_MODULE_6__/* .number */ .ai().int().nonnegative().optional(),
    failedExtractions: zod__WEBPACK_IMPORTED_MODULE_6__/* .number */ .ai().int().nonnegative().optional(),
...
const FindingSnapshotSchema = zod__WEBPACK_IMPORTED_MODULE_6__/* .object */ .Ik({
    title: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj(),
    description: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj(),
...
const VerificationStageSchema = zod__WEBPACK_IMPORTED_MODULE_6__/* .discriminatedUnion */ .gM('outcome', [
    zod__WEBPACK_IMPORTED_MODULE_6__/* .object */ .Ik({
        outcome: zod__WEBPACK_IMPORTED_MODULE_6__/* .literal */ .eu('kept'),
        model: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj().optional(),
        runtime: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj().optional(),
    }),
    zod__WEBPACK_IMPORTED_MODULE_6__/* .object */ .Ik({
        outcome: zod__WEBPACK_IMPORTED_MODULE_6__/* .literal */ .eu('revised'),
        model: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj().optional(),
        runtime: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj().optional(),
        evidence: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj().optional(),
        before: FindingSnapshotSchema,
    }),
]);
const MergeStageSchema = zod__WEBPACK_IMPORTED_MODULE_6__/* .object */ .Ik({
    model: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj().optional(),
    runtime: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj().optional(),
    absorbedFindingIds: zod__WEBPACK_IMPORTED_MODULE_6__/* .array */ .YO(zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj()),
});
const FindingProvenanceSchema = zod__WEBPACK_IMPORTED_MODULE_6__/* .object */ .Ik({
    originSkillExecutionId: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj(),
    originModel: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj().optional(),
    verification: VerificationStageSchema.optional(),
    merge: MergeStageSchema.optional(),
});
const FindingAttributionSchema = zod__WEBPACK_IMPORTED_MODULE_6__/* .object */ .Ik({
    skillExecutionId: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj(),
    skillName: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj(),
    role: zod__WEBPACK_IMPORTED_MODULE_6__/* ["enum"] */ .k5(['primary', 'corroborating']),
    matchType: zod__WEBPACK_IMPORTED_MODULE_6__/* ["enum"] */ .k5(['hash', 'semantic']).optional(),
});
const ExportedFindingV2Schema = zod__WEBPACK_IMPORTED_MODULE_6__/* .object */ .Ik({
    id: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj(),
    reportedId: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj().optional(),
    contentHash: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj(),
    severity: _types_index_js__WEBPACK_IMPORTED_MODULE_0__/* .SeveritySchema */ .Rc,
    confidence: _types_index_js__WEBPACK_IMPORTED_MODULE_0__/* .ConfidenceSchema */ .m3.optional(),
    title: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj(),
    description: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj(),
    verification: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj().optional(),
    location: _types_index_js__WEBPACK_IMPORTED_MODULE_0__/* .LocationSchema */ .TH.optional(),
    additionalLocations: zod__WEBPACK_IMPORTED_MODULE_6__/* .array */ .YO(_types_index_js__WEBPACK_IMPORTED_MODULE_0__/* .LocationSchema */ .TH).optional(),
    sourceSnippet: _types_index_js__WEBPACK_IMPORTED_MODULE_0__/* .SourceSnippetSchema */ .Ot.optional(),
    reportedBy: zod__WEBPACK_IMPORTED_MODULE_6__/* .array */ .YO(FindingAttributionSchema).min(1),
    provenance: FindingProvenanceSchema,
});
const DiscardedFindingSchema = zod__WEBPACK_IMPORTED_MODULE_6__/* .object */ .Ik({
    originSkillExecutionId: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj(),
    stage: zod__WEBPACK_IMPORTED_MODULE_6__/* ["enum"] */ .k5(['verification_rejected', 'merge_absorbed']),
    severity: _types_index_js__WEBPACK_IMPORTED_MODULE_0__/* .SeveritySchema */ .Rc,
    title: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj(),
    location: _types_index_js__WEBPACK_IMPORTED_MODULE_0__/* .LocationSchema */ .TH.optional(),
    model: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj().optional(),
    reason: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj().optional(),
    survivorFindingId: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj().optional(),
});
const FindingOriginSchema = zod__WEBPACK_IMPORTED_MODULE_6__/* .object */ .Ik({
    skillExecutionId: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj(),
    skillName: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj(),
});
const DedupeDetailV2Schema = zod__WEBPACK_IMPORTED_MODULE_6__/* .object */ .Ik({
    source: zod__WEBPACK_IMPORTED_MODULE_6__/* ["enum"] */ .k5(['warden', 'external']),
    matchType: zod__WEBPACK_IMPORTED_MODULE_6__/* ["enum"] */ .k5(['hash', 'semantic']),
    existingFindingId: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj().optional(),
    existingSkillExecutionId: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj().optional(),
    existingCommentId: zod__WEBPACK_IMPORTED_MODULE_6__/* .number */ .ai().int().positive().optional(),
    existingThreadId: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj().optional(),
    existingResolved: zod__WEBPACK_IMPORTED_MODULE_6__/* .boolean */ .zM().optional(),
    existingSkills: zod__WEBPACK_IMPORTED_MODULE_6__/* .array */ .YO(zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj()).optional(),
    actor: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj().optional(),
});
const ObservedFindingSchema = zod__WEBPACK_IMPORTED_MODULE_6__/* .object */ .Ik({
    id: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj(),
    reportedId: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj().optional(),
    severity: _types_index_js__WEBPACK_IMPORTED_MODULE_0__/* .SeveritySchema */ .Rc,
    confidence: _types_index_js__WEBPACK_IMPORTED_MODULE_0__/* .ConfidenceSchema */ .m3.optional(),
    ...
    description: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj(),
    location: _types_index_js__WEBPACK_IMPORTED_MODULE_0__/* .LocationSchema */ .TH.optional(),
    elapsedMs: zod__WEBPACK_IMPORTED_MODULE_6__/* .number */ .ai().nonnegative().optional(),
});
const FindingObservationV2Schema = zod__WEBPACK_IMPORTED_MODULE_6__/* .discriminatedUnion */ .gM('outcome', [
    zod__WEBPACK_IMPORTED_MODULE_6__/* .object */ .Ik({
        outcome: zod__WEBPACK_IMPORTED_MODULE_6__/* .literal */ .eu('posted'),
        origin: FindingOriginSchema,
        finding: ObservedFindingSchema,
    }),
    zod__WEBPACK_IMPORTED_MODULE_6__/* .object */ .Ik({
        outcome: zod__WEBPACK_IMPORTED_MODULE_6__/* .literal */ .eu('deduped'),
        origin: FindingOriginSchema,
        finding: ObservedFindingSchema,
        dedupe: DedupeDetailV2Schema,
    }),
    zod__WEBPACK_IMPORTED_MODULE_6__/* .object */ .Ik({
        outcome: zod__WEBPACK_IMPORTED_MODULE_6__/* .literal */ .eu('skipped'),
        origin: FindingOriginSchema,
        finding: ObservedFindingSchema,
        skippedReason: zod__WEBPACK_IMPORTED_MODULE_6__/* ["enum"] */ .k5(['max_findings', 'duplicate_in_batch', 'no_inline_location']),
    }),
    zod__WEBPACK_IMPORTED_MODULE_6__/* .object */ .Ik({
        outcome: zod__WEBPACK_IMPORTED_MODULE_6__/* .literal */ .eu('resolved'),
        origin: FindingOriginSchema,
        finding: ObservedFindingSchema,
        resolvedReason: zod__WEBPACK_IMPORTED_MODULE_6__/* ["enum"] */ .k5(['fix_evaluation', 'stale_check']),
    }),
    zod__WEBPACK_IMPORTED_MODULE_6__/* .object */ .Ik({
        outcome: zod__WEBPACK_IMPORTED_MODULE_6__/* .literal */ .eu('failed'),
        origin: FindingOriginSchema,
        finding: ObservedFindingSchema,
    }),
]);
const SummarySchema = zod__WEBPACK_IMPORTED_MODULE_6__/* .object */ .Ik({
    totalFindings: zod__WEBPACK_IMPORTED_MODULE_6__/* .number */ .ai().int().nonnegative(),
    totalSkillExecutions: zod__WEBPACK_IMPORTED_MODULE_6__/* .number */ .ai().int().nonnegative(),
    bySeverity: SeverityBreakdownSchema,
    byOutcome: zod__WEBPACK_IMPORTED_MODULE_6__/* .object */ .Ik({
        posted: zod__WEBPACK_IMPORTED_MODULE_6__/* .number */ .ai().int().nonnegative(),
        deduped: zod__WEBPACK_IMPORTED_MODULE_6__/* .number */ .ai().int().nonnegative(),
        ...
        failed: zod__WEBPACK_IMPORTED_MODULE_6__/* .number */ .ai().int().nonnegative(),
    }),
});
const WardenFindingsSchemaV2 = zod__WEBPACK_IMPORTED_MODULE_6__/* .object */ .Ik({
    schemaVersion: zod__WEBPACK_IMPORTED_MODULE_6__/* .literal */ .eu('2'),
    runId: zod__WEBPACK_IMPORTED_MODULE_6__/* .string */ .Yj(),
    skillExecutions: zod__WEBPACK_IMPORTED_MODULE_6__/* .array */ .YO(SkillExecutionSchema),
    findings: zod__WEBPACK_IMPORTED_MODULE_6__/* .array */ .YO(ExportedFindingV2Schema),
    discardedFindings: zod__WEBPACK_IMPORTED_MODULE_6__/* .array */ .YO(DiscardedFindingSchema).optional(),
    findingObservations: zod__WEBPACK_IMPORTED_MODULE_6__/* .array */ .YO(FindingObservationV2Schema),
 ...
 * both passes.
 */
function resolveCorroboratingAttributions(candidates, findingId, targetSkillName, targetSkillExecutionId, skillExecutionIdByName) {
...
function patchFindingsOutputV2Observations(base, results, matchedTriggers, findingObservations) {
    ...
    const findings = base.findings.map((original) => {
        ...
        const newCorroborators = resolveCorroboratingAttributions(corroboratingById, (0,_cli_output_formatters_js__WEBPACK_IMPORTED_MODULE_5__/* .displayFindingId */ .BP)(finding), primarySkillName, originSkillExecutionId, skillExecutionIdByName);
        ...
        for (const finding of report.findings) {
            findings.push({
                ...
                reportedBy: [
                    ...
                    ...resolveCorroboratingAttributions(corroboratingById, (0,_cli_output_formatters_js__WEBPACK_IMPORTED_MODULE_5__/* .displayFindingId */ .BP)(finding), report.skill, skillExecutionId, skillExecutionIdByName),
                ],
                provenance: {
                    originSkillExecutionId: skillExecutionId,
...
function writeSchemaV2OutputPair(metadata, findings, context) {
    ...
    (0,node_fs__WEBPACK_IMPORTED_MODULE_0__.mkdirSync)((0,node_path__WEBPACK_IMPORTED_MODULE_2__.dirname)(metadataPath), { recursive: true });
    (0,node_fs__WEBPACK_IMPORTED_MODULE_0__.writeFileSync)(metadataPath, JSON.stringify(metadata, null, 2));
    (0,node_fs__WEBPACK_IMPORTED_MODULE_0__.mkdirSync)((0,node_path__WEBPACK_IMPORTED_MODULE_2__.dirname)(findingsPath), { recursive: true });
    (0,node_fs__WEBPACK_IMPORTED_MODULE_0__.writeFileSync)(findingsPath, JSON.stringify(findings, null, 2));
...
function writeSchemaV2Output(context, resolvedTriggers, matchedTriggers, results, findingObservations, options) {
    const metadata = (0,_reporting_output_v2_js__WEBPACK_IMPORTED_MODULE_7__/* .buildMetadataOutputV2 */ .LE)(context, resolvedTriggers, matchedTriggers, results, options);
    const findings = (0,_reporting_output_v2_js__WEBPACK_IMPORTED_MODULE_7__/* .buildFindingsOutputV2 */ .WS)(results, matchedTriggers, findingObservations, { runId: options.runId });
...
function writeSchemaV2Outputs(inputs, context, resolvedTriggers, matchedTriggers, results, findingObservations, onError) {
    ...
    try {
        const { metadataPath, findingsPath } = (0,_base_js__WEBPACK_IMPORTED_MODULE_19__/* .writeSchemaV2Output */ ._j)(context, resolvedTriggers, matchedTriggers, results, findingObservations, { runId, runAttempt, actionRef: inputs.actionRef, failOn: inputs.failOn, reportOn: inputs.reportOn });
...
function writeSchemaV2ScheduleOutputs(inputs, context, resolvedTriggers, matchedTriggers, results) {
    ...
    const runAttempt = process.env['GITHUB_RUN_ATTEMPT'];
    try {
        const { metadataPath, findingsPath } = (0,_base_js__WEBPACK_IMPORTED_MODULE_9__/* .writeSchemaV2Output */ ._j)(context, resolvedTriggers, matchedTriggers, results, [], { runId, runAttempt, actionRef: inputs.actionRef, failOn: inputs.failOn, reportOn: inputs.reportOn });
