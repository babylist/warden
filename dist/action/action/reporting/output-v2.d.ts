import { z } from 'zod';
import type { AuxiliaryUsageAttributionMap, AuxiliaryUsageMap, EventContext, Finding, SeverityThreshold, SkillReport } from '../../types/index.js';
...
export declare const SkillExecutionSchema: z.ZodObject<{
    ...
    checkRunUrl: z.ZodOptional<z.ZodString>;
    checkRunId: z.ZodOptional<z.ZodNumber>;
    reviewEvent: z.ZodOptional<z.ZodEnum<{
        APPROVE: "APPROVE";
        REQUEST_CHANGES: "REQUEST_CHANGES";
        COMMENT: "COMMENT";
    }>>;
    checkConclusion: z.ZodOptional<z.ZodEnum<{
        success: "success";
        failure: "failure";
        cancelled: "cancelled";
        neutral: "neutral";
 ...
 * does.
 */
export declare function patchFindingsOutputV2Observations(base: WardenFindingsV2, results: TriggerResult[], matchedTriggers: ResolvedTrigger[], findingObservations: FindingObservation[]): WardenFindingsV2;
...
export declare function toFindingFromV2(finding: ExportedFindingV2): Finding;
/**
 ...
 */
export declare function reconstructSkillReportsFromV2(findingsOutput: WardenFindingsV2): SkillReport[];
export {};
